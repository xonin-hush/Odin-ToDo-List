  ...
  for (let projectIndex of projects) {
    for (let projectProperty of projectIndex) {
      if (typeof projectProperty != "number") {
        ...
        ;(0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.viewTodo)(projectProperty)
